...
<form action="companies.php" method="get">
	<?php
		for($i = 0; $i < count($companies); $i++) {
			...
			echo '<a href="companies.php" class="btn btn-danger"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>';
			echo '</div></td>';
			echo '</tr>';
			} else {
			echo '<tr> 
			...
			echo '<td><a href="?edit='.$companies[$i]->company.'"><button type="button" class="btn btn-info">';
