...
//laeme funktsiooni failis
	...
	$personalcode_error = $password_error = $gender_error = $insurance_error = $name_error = $age_error = $username_error = $create_username_error = $create_age_error = $create_name_error = $create_insurance_error = $create_gender_error = $create_personalcode_error = $create_password_error = "";
	// muutujad väärtuste jaoks
	$personalcode = $password = $gender = $insurance = $name = $age = $username = $create_username = $create_age = $create_name = $create_insurance = $create_gender = $create_personalcode = $create_password = "";
