...
class User {
	...
	function createUser($create_name, $create_email, $password_hash){
		...
		$stmt = $this->connection->prepare("SELECT email FROM disc_users WHERE email =?");
		...
		$stmt = $this->connection->prepare("INSERT INTO disc_users (name, email, password) VALUES (?, ?, ?)");
	...
	function loginUser($email, $password_hash){
		...
		$stmt = $this->connection->prepare("SELECT id, email FROM disc_users WHERE email=? AND password=?");
