...
class User
{
    ...
    function createUser($create_email, $password_hash)
    {
        ...
        $stmt = $this->connection->prepare("SELECT email FROM user.base WHERE email = ?");
        ...
        $stmt = $this->connection->prepare("INSERT INTO user.base (email, password) VALUES (?, ?)");
    ...
    function loginUser($email, $password_hash)
    {
        ...
        $stmt = $this->connection->prepare("SELECT id, email FROM user.base WHERE email=? AND password=?");
