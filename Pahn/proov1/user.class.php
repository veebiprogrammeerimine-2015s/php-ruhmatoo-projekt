...
class User {
    ...
    function createUser($create_email, $password_hash){
        ...
        $stmt = $this->connection->prepare("SELECT email FROM proov1 WHERE email = ?");
        ...
        $stmt = $this->connection->prepare("INSERT INTO proov1 (email, password) VALUES (?, ?)");
    ...
    function loginUser($email, $password_hash){
        ...
        $stmt = $this->connection->prepare("SELECT id, email FROM proov1 WHERE email=? AND password=?");
